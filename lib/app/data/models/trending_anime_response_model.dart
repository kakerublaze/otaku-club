class TrendingAnimeResponseModel {
  int? currentPage;
  bool? hasNextPage;
  List<TrendingAnimeData>? trendingDataList;

  TrendingAnimeResponseModel(
      {this.currentPage, this.hasNextPage, this.trendingDataList});

  TrendingAnimeResponseModel.fromJson(Map<String, dynamic> json) {
    currentPage = json['currentPage'];
    hasNextPage = json['hasNextPage'];
    if (json['results'] != null) {
      trendingDataList = <TrendingAnimeData>[];
      json['results'].forEach((v) {
        trendingDataList!.add(TrendingAnimeData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (trendingDataList != null) {
      data['results'] = trendingDataList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
