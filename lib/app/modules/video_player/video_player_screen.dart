                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              itemCount: controller.episodeDataList.length > 40
                                  ? 40
                                ...
                                return Column(
                                  ...
                                  () {
                                    Get.toNamed(
                                      ...
                                      arguments: {
                                        'id': controller
                                                .episodeDataList[index].id ??
                                            '',
                                        'data':
                                            controller.episodeDataList[index],
                                        'episodes': controller.episodeDataList,
                                        'name': (controller
                                                .episodeDataList[index].title ??
                                            ''),
                                      },
                                    );
                                  },
                          ...
                          if (controller.recommendationsList.isNotEmpty)
                            SizedBox(
                              ...
                              child: ListView.builder(
                                itemCount:
                                    controller.recommendationsList.length > 40
                                        ? 40
                                        : controller.recommendationsList.length,
                                scrollDirection: Axis.horizontal,
                                itemBuilder: (context, index) {
                                  return Column(
                                    crossAxisAlignment:
                                      ...
                                      Get.toNamed(
                                        ...
                                        arguments: {
                                          ...
                                          'data': controller
                                              .recommendationsList[index],
                                          'episodes':
                                              controller.recommendationsList,
                                          'name': (controller
                                                  .recommendationsList[index]
                                                  .title ??
                                              ''),
