            ...
            child: Stack(
              children: [
                ShaderMask(
                  ...
                  child: ImageHelper(
                    imagePath: controller.animeDataModel.value.cover ?? '',
                  ...
                  children: [
                        ...
                        Column(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Text(
                                controller
                                        .animeDataModel.value.title?.english ??
                                    controller
                                        .animeDataModel.value.title?.romaji ??
                                    controller
                                        .animeDataModel.value.title?.native ??
                                    '',
                                maxLines: 4,
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: controller.animeDataModel.value.type,
                                    style: const TextStyle(
                                      color: AppColor.white,
                                      fontSize: 18,
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  const WidgetSpan(
                                    child: ImageHelper(
                                      imagePath: AppImages.currentStatusIcon,
                                      width: 22,
                                      height: 22,
                                      color: AppColor.white,
                                      fit: BoxFit.contain,
                                  ...
                                  TextSpan(
                                    text:
                                        controller.animeDataModel.value.status,
                                    style: const TextStyle(
                                      color: AppColor.white,
                                      fontSize: 18,
                                      fontWeight: FontWeight.w400,
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount:
                            controller.animeDataModel.value.genres?.length,
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            child: Center(
                              child: Text(
                                controller
                                        .animeDataModel.value.genres?[index] ??
                                    '',
                                style: const TextStyle(
                                  color: AppColor.white,
                                  fontSize: 14,
                    ...
                    Table(
                      ...
                      children: [
                        ...
                        controller.buildTableRow(
                          'Start Date',
                          Text(
                            controller.animeDataModel.value.startDate?.year !=
                                    null
                        ...
                        controller.buildTableRow(
                          'End Date',
                          Text(
                            controller.animeDataModel.value.endDate?.year !=
                                    null
                                ? DateFormat('dd-MM-yyyy')
                                    .format(
                                      DateTime(
                        ...
                        controller.buildTableRow(
                          'Source',
                          Text(
                            controller.animeDataModel.value.type ?? 'MANGA',
                          ),
                        ),
                        controller.buildTableRow(
                          'Romaji',
                        ...
                        controller.buildTableRow(
                          'Synonyms',
                          controller.buildSynonymsText(
                              controller.animeDataModel.value.synonyms ?? []),
                        ),
                      ],
                    ),
                    30.heightBox,
                    ...
                    SizedBox(
                      ...
                      width: Get.width,
                      child: ListView.builder(
                        itemCount: (controller.animeDataModel.value.episodes
                                        ?.length ??
                                    0) >
                                40
                            ? 40
                            : controller.animeDataModel.value.episodes?.length,
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (context, index) {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount:
                            controller.animeDataModel.value.characters?.length,
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (context, index) {
                          return Column(
